...
while (have_posts()):
  the_post(); ?>
	<div <?php post_class(
   apply_filters('mprm-main-wrapper-class', 'mprm-main-wrapper')
 ); ?>>
		<?php
  ...
  ?>
    ...
    'mprm-content-wrapper-class',
    'mprm-container content-wrapper'
  ); ?>">
			<div class="mprm-row">
				<div class="<?php echo apply_filters(
      'mprm-menu-content-class',
      'mprm-content mprm-eight mprm-columns'
    ); ?>">
					<?php
     ...
     ?>
				...
				<div class="<?php echo apply_filters(
      'mprm-menu-sidebar-class',
      'mprm-sidebar mprm-four mprm-columns'
    ); ?>">
					<?php do_action('mprm_menu_item_slidebar'); ?>
				</div>
				<div class="mprm-clear">TEST</div>
			</div>
		</div>
	</div>
<?php
...
if (
  is_single() &&
  (!is_tax() || !is_archive()) &&
  'twentyfourteen' === get_option('template')
) {
  get_sidebar();
}
